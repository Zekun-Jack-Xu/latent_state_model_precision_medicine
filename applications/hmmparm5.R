...
save(natparm1,initiallist, file="hmmparm5.RData")
...
save(natparm1,natparm2, initiallist, file="hmmparm5.RData")
...
save(natparm1,natparm2,natparm3, initiallist, file="hmmparm5.RData")
