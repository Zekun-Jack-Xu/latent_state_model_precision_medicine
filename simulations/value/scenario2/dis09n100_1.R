...
while(b<=nboot){
    ...
    x1q=x1q/100,x2q=x2q/100,x3q=x3q/100,
    xnext1q=xnext1q/100,xnext2q=xnext2q/100,xnext3q=xnext3q/100)
    ...
    nsubjrow, augdata, valuename1, valuename2, policyname,
    disfactor=disfactor,ppsmat=ppsmat,ktrt=ktrt,
    tausq=tausq, kappa=kappa, type=type,
    tuning1=tuning1, tuning2=tuning2, print=FALSE),
    silent=TRUE)
...
save(list=c("bmean"), file="dis09n100_1.RData")
