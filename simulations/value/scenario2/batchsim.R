...
trtfun, utilfun,only_u=FALSE,ktrt=3){
    ...
    while(i <= nsubj){
       ...
       dirparm <- c(1,1,1,1,1)
       scalemat <- matrix(0, ncol=3, nrow=20)
        ...
        mod <- list(m=m,dirparm=dirparm,scalemat=scalemat,
        ...
        result <- ar1.smp.sim4(maxtime,maxstage,mod,delta,zeroparm,rateparm,
        trtfun, utilfun,ktrt)
